...
async def ping(ctx):
    ...
    await ctx.message.delete()
    embed=discord.Embed(description="Pinging...", color=0x2f3136)
    embed.set_thumbnail(url="https://i.vgy.me/b86ra3.gif")
    message = await ctx.send(embed=embed)
    await asyncio.sleep(1)

    embed=discord.Embed(description=f'```{round(Daunt.latency * 1000)}ms```', color=0x2f3136)
    embed.set_thumbnail(url="")
    embed.set_footer(text="Current User Ping: 1", icon_url=f_img)
    await message.edit(embed=embed)
    await asyncio.sleep(1)

    embed=discord.Embed(description=f'```{round(Daunt.latency * 1000)}ms```', color=0x2f3136)
    embed.set_thumbnail(url="")
    embed.set_footer(text="Current User Ping: 2", icon_url=f_img)
    await message.edit(embed=embed)
    await asyncio.sleep(1)

    embed=discord.Embed(description=f'```{round(Daunt.latency * 1000)}ms```', color=0x2f3136)
    embed.set_thumbnail(url="")
    embed.set_footer(text="Current User Ping: 3", icon_url=f_img)
    await message.edit(embed=embed)
    await asyncio.sleep(1)

    embed=discord.Embed(description=f'```{round(Daunt.latency * 1000)}ms```', color=0x2f3136)
    embed.set_thumbnail(url="")
    embed.set_footer(text="Current User Ping: 4", icon_url=f_img)
    await message.edit(embed=embed)
    await asyncio.sleep(1)

    embed=discord.Embed(description=f'```{round(Daunt.latency * 1000)}ms```', color=0x2f3136)
    embed.set_thumbnail(url="")
    embed.set_footer(text="Current User Ping: 5", icon_url=f_img)
    await message.edit(embed=embed)
    await asyncio.sleep(1)

    embed=discord.Embed(description=f'```{round(Daunt.latency * 1000)}ms```', color=0x2f3136)
    embed.set_thumbnail(url="")
    embed.set_footer(text="Current User Ping: 6", icon_url=f_img)
    await message.edit(embed=embed)
    await asyncio.sleep(1)

    embed=discord.Embed(description=f'```{round(Daunt.latency * 1000)}ms```', color=0x2f3136)
    embed.set_thumbnail(url="")
    embed.set_footer(text="Current User Ping: 7", icon_url=f_img)
